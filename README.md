...
See the full derivation in the [Kinematics & Dynamics guide](https://primcfd.github.io/RobotSCARA/kindyn/).
...
For details, refer to the [Control Pipeline page](https://primcfd.github.io/RobotSCARA/control/).
...
| Mode | Real‑Time Capable | Notes                         |
| ---- | ----------------- | ----------------------------- |
| SIL  | ❌ No              | Uses adaptive RK4 integration |
| HIL  | ✅ Yes             | Fixed‑step 1 kHz loop         |
